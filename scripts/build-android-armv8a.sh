...
sudo apt update
sudo apt-get install libopenal-dev libpng-dev libjpeg-dev libfreetype6-dev libfontconfig1-dev libcurl4-gnutls-dev libsdl2-dev zlib1g-dev libbz2-dev libedit-dev crossbuild-essential-arm64 build-essential llvm gcc g++ -y --install-recommends
